...
// margin ~39 cells from either end). Because both taps share one y, the
...
(function () {
  ...
  if (gf) gf.set("head"); // gauge charts plot piezometric head (already the default)
  window.syncPanel();

 ...
 * the machine-readable half of that: enough to put a student in front of a
 * correctly set-up simulation with one click. The README stays authoritative
 * for everything a human needs to read, and every card links to it.
 *
 ...
 *            pointer with no pack loaded is not an error: the scene, the
 *            settings and the digit still apply and the card says to draw the
 *            rig from the README.
 *   params   CONTROLS ids → values, applied after the scene loads. Selects
 *            take strings ("0".."5" for `mode`, "0".."2" for the edges,
 *            "Medium" for `budget`); checks take booleans.
 *   gauges   [[x, y], …] in metres — instruments the panel cannot express, for
 *            demos that ride a shipped scene. Rigs carry their own.
 *   digit    the personalised parameter. `base` + `step`·d, or a per-digit
 *            `table` where the measured rule is not linear, `mod: N` for
 *            "d mod N" rules, `also: [...]` for coupled controls, `unit` for
 *            the card's summary line. Omitted where the personalised thing is
 *            drawn geometry or a station on screen — those carry `digitNote`
 *            instead, which the card prints verbatim.
...
const EXERCISES = [
  ...
  // ------------------------------------------------------- open channel
  {
    ...
    scene: "s2",
    rig: null,
    params: { budget: "Medium", inQ: 0.80, channel: true },
  ...
  },
  {
    ...
    scene: "m1",
    rig: null,
    params: { budget: "Medium", channel: true, labels: true },
  ...
  },
  {
    ...
    scene: "sandbox",
    rig: null,
    params: { budget: "Medium", channel: true, labels: true, jumps: true },
  ...
  },
  {
    ...
    scene: "h23",
    rig: null,
    params: { budget: "Medium", inQ: 0.42, twLevel: 0.49, jumps: true },
    ...
    task: "Let the jump settle on the apron, then read the orange HYDRAULIC JUMP box: post the incoming Froude number and the conjugate-depth ratio y₂/y₁. Pooled, the class traces the Bélanger curve nobody solved.",
    submit: ["Fr₁", "y₂/y₁"],
    settle: 35,
    notes: "The box genuinely flutters — single frames of the same settled flow swing Fr₁ by ±25%, so take the median of a ~10 s window, never one reading.",
  },
  ...
  // ---------------------------------------------------- natural channels
  {
    ...
    scene: "m3",
    rig: null,
    params: { budget: "Medium", channel: true, gaugeField: "head" },
  ...
  },
  {
    ...
    scene: "s2",
    rig: null,
    params: { budget: "Medium", channel: true },
  ...
  // -------------------------------------------------- specific energy etc.
  {
    ...
    scene: "sandbox",
    rig: "FB-1",
    params: { budget: "Medium", inflowOn: true, inFree: false, inQ: 0.15, inLevel: 1.00,
              twOn: true, twLevel: 1.00, spoutOn: false, waveOn: false,
              openL: "1", openR: "1", openB: "0", openT: "0",
              mode: "0", channel: false, labels: false, jumps: false, gaugeField: "depth" },
  ...
  },
  {
    ...
    scene: "sandbox",
    rig: "FB-2",
    params: { budget: "Medium", inflowOn: true, inFree: false, inQ: 0.15, inLevel: 1.182,
              twOn: false, spoutOn: false, waveOn: false,
              openL: "1", openR: "1", openB: "1", openT: "0",
              mode: "3", channel: false, labels: false, jumps: false, gaugeField: "depth" },
    digit: { label: "q", control: "inQ", unit: "m²/s",
             table: [0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.55],
  ...
  },
  {
    ...
    scene: "sandbox",
    rig: "WE-1",
    params: { budget: "Medium", inflowOn: true, inFree: false, inQ: 0.10, inLevel: 1.152,
              twOn: false, spoutOn: false, waveOn: false,
              openL: "1", openR: "1", openB: "1", openT: "0",
              mode: "0", channel: false, labels: false, jumps: false, gaugeField: "depth" },
    ...
    task: "One point each on the rating curve: settle, read the gauge card's DEPTH h at x = 4.5 m and post H = h − 0.50 with your q. Pooled log-log, the class measures the exponent (≈1.6, because C_d is not constant).",
    submit: ["q", "H"],
    settle: 60,
  ...
  // ------------------------------------------------------------ momentum
  {
    ...
    scene: "sandbox",
    rig: "MO-1",
    params: { budget: "Medium", inflowOn: true, inFree: false, inQ: 0.33, inLevel: 1.7565,
              twOn: false, spoutOn: false, waveOn: false,
              openL: "1", openR: "1", openB: "1", openT: "0",
              mode: "0", channel: false, labels: false, jumps: false, gaugeField: "depth" },
  ...
  },
  {
    ...
    scene: "sandbox",
    rig: "MO-2",
    params: { budget: "Medium", spoutOn: true, spoutR: 0.09, spoutVx: 4.5, spoutVy: 0,
              openL: "0", openR: "0", openB: "1", openT: "0",
              mode: "2", channel: false, labels: false, jumps: false, gaugeField: "head" },
  ...
  // ------------------------------------------------------- pipes & losses
  {
    ...
    scene: "sandbox",
    rig: "FR-1",
    params: { budget: "Medium", spoutOn: false, openB: "0", openR: "1",
              inflowOn: true, inFree: true, inLevel: 3.30,
              twOn: true, twLevel: 2.50, cs: 0.40,
              mode: "1", channel: false, labels: false, jumps: false },
    digit: { label: "reservoir level", control: "inLevel", base: 3.30, step: 0.13, unit: "m" },
    task: "One (V, h_f) point each on a 0.40 m pressurised duct: read the two gauge traces (x = 4.0 and 8.5, L = 4.5 m) for h_f = H₁ − H₂ and hover mid-pipe for the bore-mean V. Pooled log-log, the class fits THIS pipe's friction law.",
    submit: ["level", "H₁", "H₂", "V"],
    settle: 22,
  ...
  },
  {
    ...
    rig: "LL-1",
    params: { budget: "Medium", spoutOn: false, openB: "0", openR: "1",
              inflowOn: true, inFree: true, inLevel: 3.45,
  ...
  },
  {
    ...
    scene: "sandbox",
    rig: "PU-1",
    params: { budget: "Medium", openL: "0", openR: "0", openB: "1", openT: "0",
              spoutOn: true, spoutR: 0.15, spoutVx: 1.5, spoutVy: 0,
              mode: "1", channel: false, labels: false, jumps: false },
  ...
  },
  {
    ...
    rig: "B10",
    params: { budget: "Medium", spoutOn: false, openB: "0", openR: "1",
              inflowOn: true, inFree: true, inLevel: 3.30, twOn: true, twLevel: 2.50,
              cs: 0.40, mode: "1", channel: false, labels: false, jumps: false },
  ...
  // ------------------------------------------------------- unsteady flow
  {
    ...
    scene: "hammer",
    rig: null,
    params: { budget: "Medium", speed: 0.2, gaugeField: "head" },
    gauges: [[30, 3.5]],
  ...
  },
  {
    ...
    scene: "hammer",
    rig: null,
    params: { budget: "Medium", bulk: 0.30, speed: 0.20, gaugeField: "speed", inLevel: 22.0 },
    gauges: [[30, 3.5]],
  ...
  },
  {
    ...
    scene: "hammer",
    rig: "UN-3",
    params: { budget: "Medium", inLevel: 12.0, gaugeField: "depth", bulk: 0.03, cel: 70, speed: 2 },
  ...
  },
  {
    ...
    scene: "hammer",
    rig: null,
    params: { budget: "Medium", gaugeField: "head", speed: 0.3 },
  ...
  },
  {
    ...
    scene: "dambreak",
    rig: null,
    params: { budget: "Medium", speed: 0.15 },
  ...
  // -------------------------------------------------------- quasi-steady
  {
    ...
    scene: "jet",
    rig: null,
    params: { budget: "Medium", speed: 0.15, gaugeField: "head" },
  ...
  },
  {
    ...
    scene: "sandbox",
    rig: "QS-2",
    params: { budget: "Medium", spoutOn: false, cs: 0.40,
              openL: "0", openR: "0", openB: "0", openT: "0",
              inflowOn: true, inQ: 0, inLevel: 2.00, gaugeField: "head", mode: "0" },
  ...
  // ------------------------------------------------------------- metering
  {
    ...
    scene: "venturi",
    rig: null,
    params: { budget: "Medium", inLevel: 1.70, twLevel: 1.55, mode: "1" },
    gauges: [[2.4, 0.85], [5.0, 0.85]],
  ...
  },
  {
    ...
    params: { budget: "Medium", spoutOn: false, cs: 0.40,
              openL: "1", openR: "1", openB: "0", openT: "0",
              inflowOn: true, inQ: 0, inLevel: 3.20, twOn: true, twLevel: 0.60,
              gaugeField: "head", mode: "0" },
  ...
  },
  {
    ...
    scene: "sandbox",
    rig: "CS-1",
    params: { budget: "Medium", inflowOn: false, twOn: false,
              spoutOn: true, spoutR: 0.10, spoutVx: 0.50, spoutVy: 0,
              openL: "0", openR: "1", openB: "1", openT: "0",
              gaugeField: "depth", dye: true, dyeDecay: 0 },
  ...
  // --------------------------------------------------------------- waves
  {
    ...
    scene: "wavedeep",
    rig: null,
    params: { budget: "Medium", waveOn: true, waveT: 0.60, waveA: 0.05 },
  ...
  },
  {
    ...
    scene: "wave",
    rig: null,
    params: { budget: "Medium", waveOn: true, waveT: 1.10, waveA: 0.055, gaugeField: "head" },
    digit: { label: "period", control: "waveT", unit: "s",
  ...
  },
  {
    ...
    scene: "wavesurge",
    rig: null,
    params: { budget: "Medium", waveOn: true, waveT: 1.80, waveA: 0.080, gaugeField: "depth" },
    digit: { label: "period", control: "waveT", unit: "s",
  ...
  },
  {
    ...
    rig: null,
    params: { budget: "Medium", waveOn: true, waveT: 0.60, waveA: 0.05,
              tracerOn: true, tracerX: 5.84, tracerN: 9, tracerTrail: 3, vex: 6 },
    digit: { label: "period", control: "waveT", unit: "s",
             table: [0.60, 0.75, 0.90, 1.05, 1.20, 1.35, 1.50, 1.60, 1.60, 1.60],
             also: [{ label: "stroke", control: "waveA", unit: "m",
                      table: [0.05, 0.08, 0.11, 0.15, 0.19, 0.23, 0.28, 0.30, 0.30, 0.30] }] },
  ...
  },
  {
    ...
    scene: "wave",
    rig: null,
    params: { budget: "Medium", waveOn: true, waveT: 2.10, waveA: 0.070 },
  ...
  },
  {
    ...
    scene: "waveshallow",
    rig: null,
    params: { budget: "Medium", waveOn: true, waveT: 3.0, waveA: 0.25, gaugeField: "depth" },
    gauges: [[1.0, 0.20], [1.8, 0.20]],
    digit: { label: "period", control: "waveT", unit: "s",
  ...
  // ------------------------------------------------------ dimensional analysis
  {
    ...
    // digit picks the rig as well as the numbers.
    rigTable: ["DA-1@1", "DA-1@0.5", "DA-1@0.25", "DA-1@1", "DA-1@0.5",
               "DA-1@0.25", "DA-1@1", "DA-1@0.5", "DA-1@0.25", "DA-1@1"],
    params: { budget: "Medium", inflowOn: true, inFree: false, inQ: 0.600, inLevel: 1.795,
              twOn: false, spoutOn: false, waveOn: false,
              openL: "1", openR: "1", openB: "1", openT: "0",
              mode: "0", channel: false, labels: false, jumps: false, gaugeField: "depth" },
  ...
  },
  {
    ...
    scene: "sandbox",
    params: { budget: "Medium", spoutOn: false, openL: "0", openR: "1", openB: "0", openT: "0",
              twOn: true, twLevel: 0.04, inflowOn: true, inQ: 0, inLevel: 1.80,
              gaugeField: "head", mode: "0" },
    rig: "DA-2@1",
  ...
  },
  {
    ...
    rigTable: ["DA-1@1", "DA-1@0.5", "DA-1@0.25", "DA-1@1", "DA-1@0.5",
               "DA-1@0.25", "DA-1@1", "DA-1@0.5", "DA-1@0.25", "DA-1@1"],
    params: { budget: "Medium", spoutOn: false, inflowOn: true, inFree: false, inQ: 0.600,
              inLevel: 1.795, twOn: false, openL: "1", openR: "1", openB: "1", openT: "0",
              mode: "0", channel: false, labels: false, jumps: false, gaugeField: "depth" },
    // The digit does three things here: it picks the λ third (the rig), it
    // carries DA-1's q and level for that third, and it assigns the resolution.
    digit: { label: "q", control: "inQ", unit: "m²/s",
             table: [0.600, 0.235, 0.090, 0.780, 0.295, 0.115, 0.960, 0.360, 0.135, 1.140],
             also: [{ label: "reservoir", control: "inLevel", unit: "m",
                      table: [1.795, 1.165, 0.840, 1.890, 1.210, 0.865,

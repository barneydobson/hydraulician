...
const EXERCISES = [
  ...
  },
  {
    ...
    rigWhy: { bulk: "not the shipped 0.03: a level jump on a shut pipe otherwise rings for 30+ s and wrecks the read." },
    ...
    start: "the same 60 m pipe, running, with a valve to shut",
    task: "Shut the valve, set your level, press R and let the tank settle; then open the valve and read the settled speed band as u_max and the first crossing of 0.9·u_max as t_90.",
    settle: 10,
  },
  {
    id: "UN-3",
